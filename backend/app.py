    ...
    if not os.path.exists(DB_PATH):
        ...
        if include_sample_data:
            sample_words = [
                ...
                ("understand", "理解", "easy"),
                ("use", "使用", "easy"),
                ("acquisition", "獲得", "medium"),
                ("articulate", "清楚表達", "medium"),
                ("benchmark", "基準", "medium"),
                ("compensate", "補償", "medium"),
                ("correlation", "關聯", "medium"),
                ("deduction", "推論", "medium"),
                ("discrepancy", "差異", "medium"),
                ("feasibility", "可行性", "medium"),
                ("formulate", "規劃", "medium"),
                ("hierarchy", "階層制度", "medium"),
                ("implication", "含意", "medium"),
                ("incentive", "激勵", "medium"),
                ("indispensable", "不可或缺的", "medium"),
                ("inhibit", "抑制", "medium"),
                ("integrity", "正直", "medium"),
                ("manifest", "展現", "medium"),
                ("notion", "概念", "medium"),
                ("perspective", "觀點", "medium"),
                ("relevance", "相關性", "medium"),
                ("subsequent", "隨後的", "medium"),
                ("sustain", "維持", "medium"),
                ("tangible", "具體的", "medium"),
                ("threshold", "門檻", "medium"),
                ("transmit", "傳送", "medium"),
